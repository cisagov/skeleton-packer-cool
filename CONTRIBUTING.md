...
issue](https://github.com/cisagov/skeleton-packer-cool/issues) in this
...
request](https://github.com/cisagov/skeleton-packer-cool/pulls), you will
...
```console
cd skeleton-packer-cool
pyenv virtualenv <python_version_to_use> skeleton-packer-cool
pyenv local skeleton-packer-cool
